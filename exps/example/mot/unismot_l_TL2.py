...
class Exp(MyExp):
    def __init__(self):
        ...
        self.num_classes = 35
        self.depth = 1.0 #tiny:0.33 #s:0.33 # l:1.0 # m:0.67  # x:1.33
        self.width = 1.0 #tiny:0.375 #s:0.50 # l:1.0 # m:0.75  # x:1.25
