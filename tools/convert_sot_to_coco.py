...
OUT_PATH = os.path.join(DATA_PATH, 'SOT', 'annotations')
...
if __name__ == '__main__':
    ...
    for split in SPLITS:
        if split == "test":
            ...
            data_path = os.path.join(DATA_PATH, 'SOT', 'train')
        ...
        for seq in sorted(seqs):
            ...
            ann_path = os.path.join(seq_path, 'gt/gt_sot.txt')
            ...
            for i in range(num_images):
                ...
                image_info = {'file_name': 'SOT/train/{}/IR/i{:04d}.jpg'.format(seq, i + 1),  # image name.
                              'file_name_rgb': 'SOT/train/{}/rgb/v{:04d}.jpg'.format(seq, i + 1),  # image name.
                              'file_name_low': 'SOT/train/{}/low/l{:04d}.jpg'.format(seq, i + 1),  # image name.
